...
class MyBot(BaseBot):
    ...
    async def on_start(self, session_metadata: SessionMetadata) -> None:
      print("hi im alive?")
      try:
        await self.highrise.walk_to( Position(x=13.6, y=1, z=29.6, facing='FrontRight'))
...
if __name__ == "__main__":
    room_id = "65829353bb913e783dd5b0dd"
    token = "d96e1e99e7e4e861716341010bb21f9464e9c013a433461676574d95efc8b470" 
    bot = Highrise() 
